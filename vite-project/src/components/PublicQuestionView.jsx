...
const PublicQuestionView = ({ question, index, answerChanged }) => {
    ...
    function onCheckboxChange(option, event) {
      if (event.target.checked) {
        ...
        selectedOptions = selectedOptions.filter(op_text => op_text != option.text)

        //  if selectedOptions is ['apple', 'banana', 'orange'] 
        // and option.text is 'banana', the filter method
        //  will create a new array that excludes the element 
        // 'banana'. The result will be ['apple', 'orange'].
